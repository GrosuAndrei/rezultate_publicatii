...
import ro.upt.ac.rezultate.cadruDidactic.CadruDidactic;
import ro.upt.ac.rezultate.cadruDidactic.CadruDidacticRepository;
import ro.upt.ac.rezultate.companie.Companie;
import ro.upt.ac.rezultate.companie.CompanieRepository;
import ro.upt.ac.rezultate.conventie.Conventie;
import ro.upt.ac.rezultate.conventie.ConventieRepository;
import ro.upt.ac.rezultate.conventie.Tutore;
import ro.upt.ac.rezultate.student.Student;
import ro.upt.ac.rezultate.student.StudentRepository;
import ro.upt.ac.rezultate.publicatii.Publicatie;
import ro.upt.ac.rezultate.publicatii.PublicatieRepository;
...
{	
	...
	@Bean
	public CommandLineRunner loadDataPublicatii(PublicatieRepository repository) 
	{
		return (args) -> {	
			log.info("starting initialization...");
			Publicatie p1= new Publicatie();
			p1.setResearcherId(2);
			p1.setWOS("123");
			p1.setTitle("primul");
			p1.setDoctype("ing");
			p1.setPages("13");
			p1.setSourceTitle("inspiratie");
			p1.setBookSeriesTitle("vol1");
			p1.setIssue("pr1");
			p1.setVolume("1");
			p1.setMonth("jan");
			p1.setYear("2022");
			...
			p1.setEISSN(null);
			p1.setDOI(null);
			p1.setContributorRIdIds(null);
			p1.setContributorRIdNames(null);
			p1.setNoOfAuthors(0);
